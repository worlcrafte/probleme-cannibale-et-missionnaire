...
Il pourrait être aussi intéressant de réaliser un algorithme de recherche en modifiant légèrement l'environnement de la manière suivante: une personne sur la barque à une faible chance de tomber dans l'eau. Et donc de faire en sorte d eprendre en considération qu'au moins une personne puisse tomber tout en respectant les contraintes imposés.
